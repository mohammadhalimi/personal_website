...
export const Passions = () => {
    ...
    return (
        <>
            <div className='max-w-screen-xl items-center justify-between mx-auto text-center md:mt-24 mt-12' id='Passions'>
                ...
                <div className='flex flex-wrap justify-center mt-10'>
                    {info.map((ti) => (
                        <div className="p-4 max-w-sm" key={ti.id}>
                            <div className="flex rounded-lg h-full p-8 flex-col shadow-xl cursor-pointer">
